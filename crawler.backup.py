...
def get_article_content(article_url):
    ...
    if response.status_code == 200:
        ...
        title_tag = soup.find('h1', class_='firestore-post__title') #  示例：假设标题在 <h1 class="post-title"> 中
        content_tag = soup.find('div', class_='firestore-post__main') # 示例：假设正文在 <div class="post-body"> 中
